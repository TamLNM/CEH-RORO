    ...
    $.fn.gantt = function (options) {
        ...
        var tools = {
            ...
            getMaxDate: function (element) {
                ...
                if(typeof settings.source.maxDate != "undefined")
                    maxDate = new Date(settings.source.maxDate);
                return maxDate;
            },
            ...
            getMinDate: function (element) {
                ...
                if(typeof settings.source.minDate != "undefined")
                    minDate = new Date(settings.source.minDate);
                return minDate;
            },
