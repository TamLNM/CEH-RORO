										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-1" style="height: 55px">
												<div class="row form-group">
													...
													<label class="col-md-6 col-sm-2 col-xs-2 col-form-label">Số VIN</label>
													...
													<div class="col-md-6 col-sm-6 col-xs-6">
														<input id="VINNo" style="height: 28px; font-size: 12px; padding-left: 11px" class="form-control" placeholder="Số VIN" type="text">
...
<div class="modal fade" id="choose-gate-modal" tabindex="-1" role="dialog" aria-labelledby="groups-modalLabel-1" aria-hidden="true" data-whatever="id" style="padding-left: auto; padding-right: auto; margin-top: 5%">
    <div class="modal-dialog" role="document" style="min-width: 100vw!important;">
                        ...
                        <div class="row form-group">
                        	<div class="col-6">
                        		...
                        		<div class="row mt-2">
                        			...
                        			<div class="col-md-8 col-sm-8 col-xs-8">
										<input id="scalesTruckNumber" style="height: 28px; font-size: 12px; padding-left: 11px" class="form-control" placeholder="Số xe" type="text">
									</div>	
                        		</div>
                        		<div class="row mt-2">
                    	...
                    	<table id="tblScales" class="table table-striped display nowrap" cellspacing="0" style="min-width: 99.5%">
                            <thead>
                                <tr style="width: 100%">
									...
									<th col-name="TruckNumber">Trọng lượng</th>
...
<script type="text/javascript">
    $(document).ready(function () {
    	var _columns	= ["IO", "TruckNumber", "BillOfLadingORBookingNo", "VINNo", "CargoType", "EirNo", "StockRef", "Sequence"],
    		...
    		//_scalesColumns = ["STT", "1", "TruckNumber", "TimeIn", "WeightIn", "TimeOut", "WeightOut"],
    		tbl 		= $("#contenttable"),
    		tblORDEir 	= $("#tblORDEir"),
    		//tblScales   = $("#tblScales"),
    		gateData,
		...
		tbl.newDataTable({
			scrollY: '70.30vh',
			columnDefs: [	
				{ className: "text-center", targets: _columns.getIndexs(["IO", "VINNo", "TruckNumber", "BillOfLadingORBookingNo", "Sequence"]) },
		...
		tblScales.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _scalesColumns.getIndexs(["1", "TruckNumber", "TimeIn", "WeightIn", "TimeOut", "WeightOut"]) },
			],
		...
		*/
        ...
        $("#VINNo").on('keydown', function(e){
          	if (e.which == 13){
        		...
        		if (this.value == ''){
	        		toastr['warning']("Vui lòng nhập giá trị Số VIN cần tìm!");
        		}
        		...
        		$.ajax({
					...
					success: function (data) {
						...
						if (data.list.length > 0){
							...
							toastr['warning']("Không tìm thấy lệnh theo với Số VIN: " + $("#VINNo").val() + "!");
							return;
						}	
					},
					error: function(err){
        ...
        $(document).on("click", "#contenttable tbody tr",  function(){
        	if ($("#chooseGate").text().substring(0, 3) == 'OUT'){
    			...
    			var tblData 	= tbl.getSelectedRows().data().toArray(),
    				...
    				TruckNumber = tblData[0][_columns.indexOf('TruckNumber')],
        ...
        $("#passGate").on('click', function(){
        	if ($("#chooseGate").text().substring(0, 2) == 'IN'){
	        	...
	        	if ($("#EirNo").val().substring(0,1) == 'R'){ /* RORO */
		            ...
		            gateData[0].TruckNumber = $("#TruckNumber").val();
		            gateData[0].StartDate = currentDate;
		            quayBulkData[0].TruckNumber = $("#TruckNumber").val();
	        			...
	        			$.ajax({
				            ...
				            success: function (data) {
				                if(data.deny) {
				               	...
				               	if (data.list == 1){
				               		toastr['error']("Số xe: " + $("#TruckNumber").val() + " đang được khai thác tại Cổng!");
		        					$("#passGate").attr("disabled", false);
				               		...
				               		/* ClassID == 1 */
				               		if ($("#ClassID").val() == 1){
				               			//stockOutBulkData.TruckNumber = $("#TruckNumber").val();
                ...
                success: function (data) {
                    ...
                    if(formData.action == 'add'){
                    	...
                    	if (formData.child_action == 'addNewGateData'){
							...
							get_qr($("#TruckNumber").val(), $("#EirNo").val());
                    		return;
                    	}
		...
		$("#btnScales").on('click', function(e){
			...
			$("#scalesTruckNumber").val($("#TruckNumber").val());
			scalesModal.modal('show');
		});
		...
		$("#apply-scales, #quit-scales").on('click', function(){
	        ...
	        if ($("#PINCodeOREirNo").val().substring(0,1) == 'B'){
				...
				scalesData[0].TruckNumber = $("#TruckNumber").val();
