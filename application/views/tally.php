                ...
                <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                    <table id="contenttable" class="table table-striped display nowrap" cellspacing="0" style="width: 99.5%">
                        ...
                        <tr>
                            ...
                            <th class="editor-cancel" col-name="VINNo">Số VIN/ Số xe</th>
                ...
                <div class="row ibox-footer border-top-0 mt-3">
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="row form-group">
                            ...
                            <input id="TruckNumber" class="col-md-6 col-sm-6 col-xs-6 form-control form-control-sm border-e" placeholder="Số xe" readonly>
                        </div>
                         <div class="row form-group">
    ...
    function openFullscreen() {
        ...
        var dataTable = tbl.newDataTable({
            ...
            columnDefs: [
                ...
                { className: "text-center", targets: _columns.getIndexs(['JobTypeName', 'BillOfLadingORBookingNo', 'VINNo', "JobModeInID", "MethodInID", /*'JobModeInOut', 'MethodInOut',*/ 'JobStatus', 'Remark'])},           
                { className: "hiden-input", targets: _columns.getIndexs(["StockRef", "VoyageKey", "IsLocalForeign", "ClassID", "BillOfLading", "BookingNo", "TransitID", "CarWeight", "JobModeOutID", "MethodOutID", "DamagedTypeID", "DamagedID", "KeyCheck", "Block", "Bay", "Row", "Tier", "Area", "PaymentTypeID",  "BillCheck", "Sequence", "JobTypeID", "EirNo", "CargoType", "rowguid"])},     
            ],
        ...
        tblEquipment.newDataTable({
            scrollY: '30vh',
            columnDefs: [
                { type: "num", className: "text-center", targets: _equiqmentColumns.indexOf('STT')},       
                { className: "text-center", targets: _equiqmentColumns.getIndexs(["EquipmentTypeID", "EquipmentID", "EquipmentName", "IsOwn"])},
            ],
            order: [[ _equiqmentColumns.indexOf('STT'), 'asc' ]],
            paging: false,
            keys:true,
            autoFill: {
                focus: 'focus'
        ...
        */
        ...
        $("#XT").on('click', function(){    
            ...
            var tblData     = tbl.getSelectedRows().data().toArray()[0],
                ...
                TruckNumber = tblData[_columns.indexOf('VINNo')],
                                    ...
                                    switch(colname){
                                        ...
                                        */
                                        ...
                                        case "DamagedID":
                                            break;
                                        case "VINNo":
                                            if (rData['TruckNumber'] != '' && rData[colname] != null){
                                                val = rData[colname];                                                
                                            }
                                            else if (rData['TruckNumber'] != ''){
