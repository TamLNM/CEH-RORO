...
<div class="row">
	<div class="col-xl-12">
		<div class="ibox collapsible-box">
			...
			<div class="ibox-head">
				<div class="ibox-title">BÁO CÁO - DỮ LIỆU CỔNG</div>
				...
				<div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
					<table id="contenttable" class="table table-striped display nowrap" cellspacing="0">
						...
						<tr>
							...
							<th col-name="BillOfLadingORBookingNo">Số vận đơn/ Số booking</th>
...
<script type="text/javascript">
	$(document).ready(function () {
		var _columns 	= ["STT", "rowguid", "StockRef", "VoyageKey", "GateInID", "GateOutID", "StartDate", "FinishDate", "InOut", "ClassID", "TransitID", "CusTypeID", "CusID", "EirNo", "InvDraftNo", "InvNo", "PaymentTypeID", "BillOfLading", "BookingNo", "BillOfLadingORBookingNo", "VINNo", "KeyNo", "JobTypeID", "MethodID", "BillCheck", "Sequence", "CarWeight", "Block", "Bay", "Row", "Tier", "Area", "TruckNumber", "Remark"],
			tbl 		= $('#contenttable'),
			parentMenuList 	= {};
console.log(_columns[32]);
		...
		var tblData = tbl.newDataTable({
			...
			columnDefs: [
				...
				{ className: "text-center", targets: _columns.getIndexs(["GateInID", "GateOutID", "StartDate", "FinishDate", "InOut", "ClassID", "TransitID", "CusTypeID", "CusID", "EirNo", "InvDraftNo", "InvNo", "PaymentTypeID", "BillOfLadingORBookingNo", "VINNo", "KeyNo", "JobTypeID", "MethodID", "BillCheck", "Sequence", "CarWeight", "Block", "Bay", "Row", "Tier", "Area", "TruckNumber", "Remark"])},
		...
		$("#search").on('click', function(){
			...
			$.ajax({
                url: "<?=site_url(md5('ReportAndStatistics') . '/' . md5('rpGate'));?>",
				dataType: 'json',
				data: formData,
				type: 'POST',
							...
							var r = [] , rData = dataList[k];
                                ...
                                $.each(_columns, function(idx, colname){
                                    ...
                                    switch(colname){
                                    	...
                                    	case "InOut":
                                    		if (rData[colname] == 1){
                                    			val = '<input class="hiden-input">Vào'
                                    		}
                                    		else{
                                    			val = '<input class="hiden-input">Ra';
                                    		}
                                    		break;
                                    	case "ClassID":
                                    		if (rData[colname] == 1){
