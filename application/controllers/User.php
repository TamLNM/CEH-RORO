...
//                        );
//                        $this->ceh->insert('SYS_LOGIN_HISTORY', $set);
                        ...
                        if ($result['GroupID'] == 'GroupAdmin' || $result['GroupID'] == 'GroupVesselOwner'){
                            redirect(md5('home'));
                        }
                        else if ($result['GroupID'] == 'GateGroup'){
                            redirect(md5('gate'));
                        }
                        else if ($result['GroupID'] == 'Tally'){
                            redirect(md5('tally'));
                        }
                        else if ($result['GroupID'] == 'Che'){
                            redirect(md5('che'));
                        }
                    }
    ...
    public function groups() {
        ...
        if($this->input->post('id')) {
            ...
            $this->funcs->udi_my("DELETE FROM groups WHERE group_id = ? AND YardID = ?", array($id, $this->YardID));
            redirect(md5('user') . '/' . md5('groups'));
